...
This advanced tutorial covers spatial pattern detection:

- Running gene set enrichment analysis with `STenrich`
- Using MSigDB pathway databases for spatial enrichment
- Identifying genes with directional expression gradients using `STgradient`
- Visualizing enrichment results and spatial gradient patterns
- Applying these methods to CosMx-SMI and other single-cell resolution platforms
