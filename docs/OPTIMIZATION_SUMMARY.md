...
**Conclusion:** 80% of time is spent in just 2 functions: DynamicTreeCut
...
- **Root cause:** Bottlenecks are in external packages (DynamicTreeCut,
  Matrix), not spatialGE code
...
1.  **OPTIMIZATION_REPORT.md** - Detailed analysis with implementation
    plan
2.  **PERFORMANCE_ANALYSIS.md** - Raw profiling data and research
    findings
...
4.  **Document:** Update package documentation with performance
    guidelines

------------------------------------------------------------------------

**Research conducted using:** - Profiling with `microbenchmark` - Web
research via `ddg_search.py` - Analysis of legacy vs refactored code
