...
- color_by:
  ...
  the variable in `x@spatial_meta` used to color points in the plot. If
  NULL, each sample is assigned a different color

- categorical:

  logical indicating whether or not to treat `color_by` as a categorical
