##
# STenrich Legacy Implementation
# Original implementation for reproducibility with previous results
#
# @description This file contains the original STenrich function implementation
# for reproducibility. Please use STenrich() in STenrich.R for new analyses.
#
# @importFrom magrittr %>%
...
STenrich_legacy = function(x=NULL, samples=NULL, gene_sets=NULL, score_type='avg', reps=1000,
  ...
  if(verbose){
    cat(paste0('STenrich_legacy completed in ', round(end_t, 2), ' min.\n'))
  }
