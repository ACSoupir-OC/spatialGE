...
#' @details
#' \strong{This is the legacy implementation from version 1.x.} Use `STgradient` for new projects.
#' 
...
#'
STgradient_legacy = function(x=NULL, samples=NULL, topgenes=2000, annot=NULL, ref=NULL, exclude=NULL,
