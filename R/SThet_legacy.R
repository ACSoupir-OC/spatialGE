##
# SThet_legacy.R - Legacy Implementation for Reproducibility
# 
# This file contains the original SThet implementation from FridleyLab/spatialGE
# DO NOT MODIFY - used as ground truth for verifying refactored implementation
#
# Created: 2026-03-19
# Source: FridleyLab/spatialGE (original)
#

# ============================================================================
# SThet - Main legacy function (distance-based weights)
# ============================================================================
...
#' @export
#
SThet_legacy = function(x=NULL, genes=NULL, samples=NULL, method='moran', k=NULL, overwrite=TRUE,
                 cores=NULL, verbose=TRUE){
  # Record time
  zero_t = Sys.time()
  if(verbose){
    cat(paste0('SThet_legacy started.\n'))
  }
  ...
  if(verbose){
    cat(paste0('SThet_legacy completed in ', round(end_t, 2), ' min.\n'))
  }
...
# ============================================================================
# Helper functions - calc_spatial_autocorr and wrappers
# ============================================================================
...
# ============================================================================
# SThet_invdist_test - Legacy with statistical testing (alternative implementation)
# ============================================================================

##
# @title SThet_invdist_test_legacy: Computes spatial autocorrelation with statistical tests
...
#' @export
#
SThet_invdist_test_legacy = function(x=NULL, genes=NULL, samples=NULL, method='moran', k=NULL, overwrite=T, cores=NULL){
  # Select sample names if NULL or if number entered
  if (is.null(samples)){
    samples = names(x@tr_counts)
  } else{
...
# @description Calculates Moran's I from ST data using moran.test
#
# @param x an STlist with normalized gene counts.
# @param combo a table with combinations of samples and genes to calculate statistics
# @return x a STlist including the calculated Moran's I
...
# @description Calculates Geary's C from ST data using geary.test
#
# @param x an STlist with normalized gene counts.
# @param combo a table with combinations of samples and genes to calculate statistics
